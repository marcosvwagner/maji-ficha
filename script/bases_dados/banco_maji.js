...
const bancoMajis = {
    ...
    "base": {
        "godai": { nome: "Godai (Fala)", forma: "Fala", tipo: "Base", subtipo: "Essência", custo: "1 ação", desc: "Dispara uma bola de essência contra 1-alvo a alcance 0-3 (Esquiva DA 6 ou Defesa), causando 2d6 de dano." },
        "gidama": { nome: "Gidama (Escrita)", forma: "Escrita", tipo: "Base", subtipo: "Essência", custo: "2 ações - Pequeno", desc: "Cria uma explosão de essência que sai do chão, atingindo todo alvo a alcance 1-2 (Esquiva DA 8 ou Defesa) causando 5d6 de dano. (Pergaminho Grande)" },
        "godama": { nome: "Godama (Sinal)", forma: "Sinal", tipo: "Base", subtipo: "Essência", custo: "2 ações", desc: "Dispare uma explosão de essência, escolha uma direção e acerte todos a alcance 0-1 (Esquiva DA 8 ou Defesa) causando 3d6 de dano." }
    },
    ...
    "fala": {
        ...
        "protecao_agua": { nome: "Proteção da Água", forma: "Fala", tipo: "Elemental", subtipo: "Chuva", custo: "1 ação", desc: "Cria proteção em 1-alvo a alcance 0 com 3-usos. Gaste para reduzir 2 dano (ou o dobro contra fogo)." },
        ...
        "rugido_titanico": { nome: "Rugido Titânico", forma: "Fala", tipo: "Elemental", subtipo: "Vento", custo: "1 ação", desc: "Teste oposto de Presença contra até 3-alvos (alcance 0-2). Você tem +1d10. Falha causa Medo 1." },
        ...
        "phoenix": { nome: "Phoenix", forma: "Fala", tipo: "Celeste", subtipo: "Estrelas", custo: "1 ação", desc: "Recebe 1-uso. Se morrer, gasta para reviver com 1 PV. Funciona mesmo com corpo destruído." },
        ...
        "sopro_chamas": { nome: "Sopro de Chamas", forma: "Fala", tipo: "Celeste", subtipo: "Sol", custo: "1 ação", desc: "Labareda em cone alcance 0-2 (Esquiva DA 12 ou Defesa). Causa 2d6 dano de fogo." },
        ...
        "reequipar": { nome: "Reequipar", forma: "Fala", tipo: "Cósmica", subtipo: "Espaço", custo: "1 ação", desc: "Guarde ou equipe teleportando até 2 equipamentos preparados. Limite de preparados = Nível da Maji." },
        ...
        "tartaruga_lebre": { nome: "Tartaruga e Lebre", forma: "Fala", tipo: "Cósmica", subtipo: "Tempo", custo: "1 ação", desc: "Deixe 1-alvo a alcance 0-1 com condição Lento ou Rápido por 3 rodadas." },
    ...
    "escrita": {
        // Chuva
        "agua_mortal": { nome: "Água Mortal", forma: "Escrita", tipo: "Elemental", subtipo: "Chuva", custo: "3 ações - Grande", desc: "2-alvos a alcance 0-2 fazem Vigor (DA 6) ou recebem 2d6 dano direto por 3 rodadas." },
        "campo_eletrizante": { nome: "Campo Eletrizante", forma: "Escrita", tipo: "Elemental", subtipo: "Chuva", custo: "2 ações - Pequeno", desc: "Todos a alcance 0-1 (menos você) recebem condição Condutivo." },
        
        // Natureza
        "golem_elemental": { nome: "Golem Elemental", forma: "Escrita", tipo: "Elemental", subtipo: "Natureza", custo: "2 ações - Pequeno", desc: "Cria Golem (30 Vida, Reduzir 5). Soca por 3d6 ou explode por 4d6." },
        "casulo_chukaku": { nome: "Casulo Chukaku", forma: "Escrita", tipo: "Elemental", subtipo: "Natureza", custo: "3 ações - Grande", desc: "Protege todos a alcance 0-1. Casulo tem PV = 10x Nível Maji." },
        ...
        // Estrelas
        "orion": { nome: "Orion", forma: "Escrita", tipo: "Celeste", subtipo: "Estrelas", custo: "3 ações - Grande", desc: "Invoca Orion (20 Vida). Você não age. Ele tem Balestra de Luz (3d6) e Espada Celeste (5d6)." },
        ...
        "kabumu": { nome: "Kabumu", forma: "Escrita", tipo: "Celeste", subtipo: "Sol", custo: "2 ações - Pequeno", desc: "Pergaminho explode no tempo definido. Causa 2d6 fogo em todo alvo a alcance 0 dele." },
        ...
        "bolsa_papel": { nome: "Bolsa de Papel", forma: "Escrita", tipo: "Cósmica", subtipo: "Espaço", custo: "2 ações - Pequeno", desc: "Guarda 5 itens no papel (Grande guarda 10). Seres vivos não entram." },
        ...
        "tempo_infinito": { nome: "Tempo Infinito", forma: "Escrita", tipo: "Cósmica", subtipo: "Tempo", custo: "3 ações - Grande", desc: "Para o tempo no alcance 0-1. Ninguém age. Você pode manter gastando 1 Ponto Cósmico por rodada." }
    },
    ...
    "sinal": {
        ...
        "tsunami": { nome: "Tsunami", forma: "Sinal", tipo: "Elemental", subtipo: "Chuva", custo: "2 ações", desc: "Onda a frente alcance 1-3. Força (DA 14) ou sofrem 2d6 dano e -2 em Agilidade." },
        ...
        "muro_defesa": { nome: "Muro de Defesa", forma: "Sinal", tipo: "Elemental", subtipo: "Natureza", custo: "2 ações", desc: "Reação. Quando 1-alvo a alcance 0-2 for atacado, cria muro com Reduzir 5." },
        ...
        "impacto_ventania": { nome: "Impacto da Ventania", forma: "Sinal", tipo: "Elemental", subtipo: "Vento", custo: "2 ações", desc: "Joga 1-alvo a alcance 1 contra outro (Esquiva DA 8). Impacto causa 3d6 Perfurar-2 em área." },

        // Estrelas
        "leo": { nome: "Leo", forma: "Sinal", tipo: "Celeste", subtipo: "Estrelas", custo: "2 ações", desc: "Cria Teko-kagi nas mãos (dano base + Nível Maji). Dura 3 rodadas." },
        "sagittarius": { nome: "Sagittarius", forma: "Sinal", tipo: "Celeste", subtipo: "Estrelas", custo: "2 ações", desc: "Cria Arco Recurvo de luz. Flechas infinitas. 4-usos. Causa dano normal." },
        ...
        "raio_solar": { nome: "Raio Solar", forma: "Sinal", tipo: "Celeste", subtipo: "Sol", custo: "2 ações", desc: "Raio em 1-alvo a alcance 0-1 (Esquiva DA 8). 2d6 fogo. Pode reativar prox turno para +1d6." },
        ...
        "defletir_ataque": { nome: "Defletir Ataque", forma: "Sinal", tipo: "Cósmica", subtipo: "Espaço", custo: "2 ações", desc: "Reação. Teste de Agilidade + Nível Maji contra ataque inimigo. Se vencer, devolve o ataque." },
        ...
        "estagnacao": { nome: "Estagnação", forma: "Sinal", tipo: "Cósmica", subtipo: "Tempo", custo: "2 ações", desc: "Prende 1-alvo no tempo. Fica Desorientado até o fim da condição." },
