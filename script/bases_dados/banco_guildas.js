const dadosGuildas = {
    "ardor": {
        ...
        hab2: { nome: "Disciplina Formidável", desc: "Pode realizar a Manobra Crítica Desarmar com 1 Crítico em vez de 2, porém apenas com ataques desarmados a Alcance 0.", req: "Força 2" },
        hab3: { nome: "Arma Temporária", desc: "Gaste 1 Ação para pegar um objeto (pedra, cadeira, garrafa), que causa 2d6 de dano. Sua Força é usada para atacar e, após acertar um golpe, a arma quebra.", req: "Sentidos 2" },
    ...
    "blugarony": {
        ...
        hab2: { nome: "Disciplina Formidável", desc: "Uma vez por cena, você pode ignorar qualquer Penalidade que esteja sofrendo até o fim do seu Turno de Equipe.", req: "Vigor 3" },
        hab3: { nome: "Maratona Implacável", desc: "Sempre que acertar um ataque desarmado, você pode se mover para um local a Alcance 1 sem gastar ação.", req: "Agilidade 2, Força 3" },
    ...
    "borealis": {
        ...
        hab3: { nome: "Corte X", desc: "Enquanto estiver empunhando duas armas, ao realizar um ataque, você pode gastar 1 Ação para atacar novamente com a segunda arma.", req: "Agilidade 3" },
        hab4: { nome: "Ponto de Ruptura", desc: "Você identifica o ponto fraco de um traje só de olhar. Em ataques usando Agilidade, você pode usar as Manobras Críticas Preciso e Quebrar com 1 Crítico em vez de 2.", req: "Sentidos 2" }
    },
    "canis": {
        bonus: "Agilidade",
        ...
        hab3: { nome: "Fúria Ferion", desc: "Acostumados ao calor, possuem reduzir 2 contra dano de fogo. Além disso, toda Maji de Fala ou Sinal de Sol que causar dano recebe +1d6 de dano.", req: "Vigor 2, Estudos 2" },
    ...
    "duellante": {
        ...
        hab2: { nome: "Bravo Duellante", desc: "Uma vez por Rodada, após usar Contra Ataque, você também pode realizar a reação Esquiva para tentar evitar sofrer o ataque. Em uma cena de Maji-Du, o oponente precisa superar em 2 nos Pontos de Essência gastos para Contra Ataque.", req: "Agilidade 3, Estudos 3" },
    ...
    "justica": {
        ...
        hab4: { nome: "Justiça Cega", desc: "Você recebe +5 para perceber com audição (Sentidos) e ler as intenções (Carisma).", req: "Sentidos 2, Carisma 2" }
    },
    "nadyat": {
        bonus: "Vigor",
        filtrosMaji: ["fala", "sinal", "escrita", "base"],
        ...
        hab2: { nome: "Berserker", desc: "Ao ativar Superar Limites, você recebe +Xd6 de dano em ataques com arma, onde X é o nível do Superar Limites ativo.", req: "Força 2, Vigor 3, Carisma 2" },
        hab3: { nome: "Legado de Firion", desc: "O legado de superação de Firion vive em cada membro. Ao ativar o 3° Superar Limites, você recebe o dobro do efeito (ou seja, 2 Ações e +10 em DA).", req: "Vigor 3, Carisma 2" },
        hab4: { nome: "Rompendo as Barreiras", desc: "Quando usar Superar Limites, você remove qualquer Condição que esteja sofrendo, a menos que escolha mantê-la.", req: "Vigor 3" }
    },
    "oberon": {
        bonus: "Vigor",
        ...
        hab2: { nome: "Ataques Fluidos", desc: "Ao realizar um ataque com uma arma, uma vez por Turno de Equipe, você pode gastar 1 Ação para realizar outro ataque com uma arma diferente.", req: "Agilidade 2, Força 2" },
        hab3: { nome: "Mestre das Armas", desc: "Para cada arma diferente que você usar para atacar no mesmo Turno de Equipe, você recebe +1d6 de dano no próximo ataque.", req: "Força 3" },
    ...
    "polares": {
        ...
        hab4: { nome: "Sangue de Geada", desc: "A condição Congelado em você precisa de 4 cargas para ativar.", req: "Vigor 2" }
    },
    "strike": {
        bonus: "Sentidos",
        ...
        hab3: { nome: "Raciocinio Rápido", desc: "Você é capaz de se adaptar rapidamente. Uma vez por rodada, se falhar ao usar a reação Esquiva, pode usar a reação Defesa.", req: "Agilidade 2, Sentidos 3" },
    ...
    "tayport": {
        ...
        hab2: { nome: "Portal Tático", desc: "Uma vez por Turno de Equipe, pode usar Sem Obstáculos para teleportar um ataque de projétil, aumentando efetivamente o alcance do ataque.", req: "Agilidade 2" },
        ...
        hab4: { nome: "Salto de Coordenação", desc: "Sempre que gastar um uso de Sem Obstáculos, ganha 1 Ação.", req: "Agilidade 2, Estudos 4" }
    },
    "tigre": {
        bonus: "Agilidade",
        filtrosMaji: ["fala", "base"],
        ...
        hab3: { nome: "Ferocidade", desc: "Ao realizar um ataque com arma, você pode escolher sofrer de -2 no ataque para receber +1d6 de dano.", req: "Força 2" },
    ...
    "yastrev": {
        ...
        hab2: { nome: "Estrangular", desc: "Enquanto estiver imobilizando um alvo, você pode gastar 1 Ação para causar 2d6 de dano que o alvo não pode reduzir e impedi-lo de usar Maji de Fala nesta rodada.", req: "Força 3" },
        ...
        hab4: { nome: "Velocidade de Rapina", desc: "Uma vez por Turno de Equipe, pode usar a Ação Mover sem gastar Ações.", req: "Agilidade 2" }
    },
    "blusan": {
        bonus: "Estudos",
    ...
    "exterminadores": {
        ...
        hab2: { nome: "Auto Sacrificio", desc: "Sempre que você escolher não usar uma Reação, no seu próximo ataque você recebe +1d6 de dano.", req: "Vigor 3" },
    ...
    "fulmen": {
        ...
        slotsArmas: [
            { label: "Arma", filtros: ["arma"] },
            // CORREÇÃO: Nome padronizado para "Balestra"
            { label: "Balestra", filtros: ["balestra"] }
        ],
        slotsTraje: [
            { label: "Traje de Couro", filtros: ["couro"] }
        ...
        hab3: { nome: "Passo de Pressão", desc: "Uma vez por rodada, quando você empurrar um alvo, você pode se mover Alcance 1 imediatamente em direção a ele, sem gastar Ação.", req: "Agilidade 3" },
        hab4: { nome: "Vira-Corrente", desc: "Uma vez por rodada, ao realizar Contra-ataque com sucesso, você pode empurrar o alvo para um local a Alcance 1. Se atingir obstáculo, cause +1d6 de dano.", req: "Força 2" }
    },
    "garra_mansa": {
        bonus: "Carisma",
        filtrosMaji: [],
        ...
        hab2: { nome: "Forte Companheiro", desc: "Você pode adquirir uma Criatura de Nível de Ameaça 2. Se preferir, pode melhorar a ficha de uma Criatura de NA 0 ou 1.", req: "Carisma 3" },
    ...
    "prime": {
        bonus: "Estudos",
        filtrosMaji: ["sinal", "base"],
        // CORREÇÃO: Segundo slot agora é Arma (não sub-arma)
        slotsArmas: [
            { label: "Arma", filtros: ["arma"] },
            { label: "Arma", filtros: ["arma"] }
        ],
        ...
        hab2: { nome: "Convergência Dissonante", desc: "Uma vez por cena, ao usar uma Maji, você pode fazer uma outra Maji ao mesmo tempo, no mesmo ato. No entanto, a fusão te machuca, causando Atordoado 1.", req: "Estudos 3, Vigor 2" },
        hab3: { nome: "Subtração Máxima", desc: "Ao usar uma Maji, você pode aumentar o dano em até 2d6, e sofre o mesmo valor de dano em si mesmo sem poder reduzir.", req: "Estudos 4, Vigor 2" },
        hab4: { nome: "Subversão Instável", desc: "Você pode alterar parâmetros numéricos ao utilizar uma Maji. Sempre que fizer isso, você recebe Exausto devido à potência da Maji.", req: "Estudos 5, Vigor 2" }
    },
    "runa": {
        bonus: "Estudos",
        filtrosMaji: ["escrita", "base"],
    ...
    "varbar": {
        ...
        hab2: { nome: "Ato Final", desc: "Ao escolher Agarre A Vida, automaticamente recebe 15+ (ativando a condição Morrendo, mas ficando consciente).", req: "Vigor 2" },
        hab3: { nome: "Vigoroso", desc: "Você é imune aos efeitos causados pela 1ª Penalidade.", req: "Vigor 3" },
        hab4: { nome: "Furiso", desc: "Duas vezes por cena, pode ativar essa habilidade, recebendo +1d10 por 3 rodadas em testes de Força ou Agilidade. Ao final, recebe Atordoado 1 (ou Atordoado 2 na segunda ativação).", req: "Agilidade 2, Força 2, Vigor 2" }
    },
    "ampulheta": {
        bonus: "Estudos",
        ...
        hab4: { nome: "Cronologia Quebrada", desc: "Uma vez por cena, você pode escolher obter sucesso automático em qualquer teste, antes de rolar os seus dados.", req: "Agilidade 4" }
    },
    "ateliere": {
        bonus: "Sentidos",
        filtrosMaji: ["sinal", "base"],
        ...
        hab3: { nome: "Estourar Ponto", desc: "Uma vez por rodada, quando causar dano em um alvo Sangrando, pode gastar 1 Ação para impedir o alvo de usar a reação Defesa.", req: "Sentidos 3, Força 2" },
    ...
    "prizark": {
        ...
        hab2: { nome: "Aprisionador Implacável", desc: "Enquanto estiver Imobilizando um alvo com arma de corrente, você pode gastar 1 Ação para causar a condição Sangrando no alvo.", req: "Força 3" },
        ...
        hab4: { nome: "Redoma de Correntes", desc: "Usando duas armas de corrente, você pode gastar 3 Ações para realizar um ataque circular que atinge todos os alvos dentro do alcance da arma.", req: "Agilidade 3, Força 3" }
    },
    "sacrifice": {
        bonus: "Agilidade",
        filtrosMaji: ["fala", "base"],
    ...
    "umbral": {
        ...
        hab4: { nome: "Inversão Sombria", desc: "Uma vez por cena, ao realizar a reação Contra Ataque com sucesso, você pode causar a condição Sangrando no alvo.", req: "Agilidade 2" 
